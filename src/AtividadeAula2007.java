...
public class AtividadeAula2007 {
    public static void main(String[] args) {
        ...
        //Crie um programa que define 2 vetores de tamanho igual. Em seguida, crie um terceiro vetor de mesmo tamanho onde o valor em cada posição do terceiro é resultado da soma dos valores nos vetores 1 e 2 na mesma posição.
