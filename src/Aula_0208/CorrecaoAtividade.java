...
public class CorrecaoAtividade {
    ...
    public static void main(String[] args) {
        ...
        // Implemente um método que receba uma lista de números e retorne a média aritmética dos elementos presentes na lista.
            ...
            //List<Double> numeros = new ArrayList<Double>(List.of(4.0, 5.0, 7.0, 9.0, 1.8, 2.0));
        ...
        // Crie um enum chamado EstacoesDoAno com os valores representando as estações do ano (Verão, Outono, Inverno e Primavera).
        System.out.println("Digite o mês doa no (1-12): ");
        ...
        // Escreva um programa que receba o mês atual do usuário e informe a estação do ano correspondente.
