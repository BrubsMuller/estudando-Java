...
public class EstudoEstruturas {
    public static void main(String[] args) {
        /*System.out.print("Digite o seu nome: "); // só o print não quebra linha e você pode usar o /n caso queira quebrar
        * System.out.println("Oi"); //  o print ln quebra linha automático*/

        //Scanner = vai permitir a leitura de dados do teclado
        Scanner entrada = new Scanner(System.in); // in depois do System é para entrada de dados
        ...
        double altura = entrada.nextDouble(); // digite o nome com virgula 1,78
        ...
        // Exercicio: Criem uma versão com while do código
        // acima
